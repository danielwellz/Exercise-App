/*
Summary:
- Page-level move selection entrypoint (`moveBySlug` from route slug).
- Passes selected move and playback controls into `Viewer3D`.
- Receives rep/phase callbacks produced by the per-frame animation runtime.
*/
