/*
Summary:
- Discovers skinned skeletons and maps heterogeneous bone names into canonical rig keys.
- Supports Mixamo mapping, fuzzy/custom mapping, joint-chain fallbacks, and structural fallbacks.
- Captures rest pose quaternions used for normalized pose application.
*/
