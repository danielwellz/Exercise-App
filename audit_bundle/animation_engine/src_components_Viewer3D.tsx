/*
Summary:
- Primary runtime component for per-frame animation (`RigCharacter` useFrame).
- Builds normalized rig, runs procedural animator, then applies grounding each frame.
- Contains fallback mannequin path if rig mapping fails.
*/
import {
  Component,
  Suspense,
